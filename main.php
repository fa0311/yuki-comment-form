...
class yuki_comment_form
{
    ...
    function comment_form_change($defaults)
    {
        ...
        $defaults['logged_in_as'] .= '<p class="logged-in-as"><a href="" aria-label=" プロフィールを編集"> としてログイン中</a>のため現在コメント機能は使用できません。<a href="https://fnjpnews.com/wp-login.php?action=logout&amp;redirect_to=https%3A%2F%2Ffnjpnews.com%2FNews%2F7888&amp;_wpnonce=2dca9fc999">ログアウトしますか？</a></p>';
